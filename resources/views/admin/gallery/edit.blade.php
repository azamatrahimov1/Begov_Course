...
@section('content')
    ...
    <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light">Tahrirlash/</span> Galereya</h4>
        ...
        <div class="card-body">
            <form method="POST" action="{{ route('gallery.update', $gallery->id) }}"
                ...
                <div class="mb-3">
                    ...
                    <input type="file" class="form-control" name="image" value="{{ $gallery->image }}" accept="image/*">
                    @error('image')
