            ...
            <div class="card-body">
                <div class="mb-3">
                    <form method="POST" action="{{ route('chapters.update', ['chapter' => $chapter->id]) }}">
                        ...
                        <div class="mb-3">
                            <label for="parent_id" class="form-label">Chapter Name:</label>
                            <input type="number" class="p-2 mb-2 bg-light text-dark form-control" name="parent_id"
                                   value="{{ old('parent_id', $chapter->parent_id) }}" required>
                        </div>
