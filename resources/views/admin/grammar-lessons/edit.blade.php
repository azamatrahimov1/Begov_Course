            ...
            <form method="POST" action="{{ route('lesson-1.update', $lesson_1->id) }}" enctype="multipart/form-data">
                ...
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control" name="name_image"
                           value="{{ old('name_image', $lesson_1->name_image) }}">
                </div>

                <div class="mb-3">
                    <label for="image" class="form-label">Image:</label>
                    <input type="file" class="form-control mb-1" name="image"
                           value="{{ old('image', $lesson_1->image) }}">
                    @if($lesson_1->image)
                ...
                <div class="mb-3">
                    ...
                    @if($lesson_1->pdf)
                        <p>Current PDF: <a href="{{ asset('storage/'.$lesson_1->pdf) }}"
                                           target="_blank">{{ $lesson_1->pdf }}</a></p>
                    @endif
                ...
                <div class="mb-3">
                    ...
                    <input type="file" class="form-control mb-1" name="voice"
                           value="{{ old('voice', $lesson_1->voice) }}">
                    @if($lesson_1->voice)
                        <audio controls>
                ...
                <div class="mb-3">
                    ...
                    <textarea name="homework" id="tinymce" class="form-control"
                              rows="5">{{ old('answer', $lesson_1->homework) }}</textarea>
                </div>

                <div class="mb-3">
                    <label for="answer" class="form-label">Answer:</label>
                    <textarea name="answer" id="tinymce" class="form-control"
                              rows="5">{{ old('answer', $lesson_1->answer) }}</textarea>
                </div>
