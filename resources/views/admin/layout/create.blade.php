        ...
        <aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
            <div class="app-brand demo">
              ...
              <span class="app-brand-logo demo">
                  <img src="{{ asset('admin_assets/img/avatars/1.jpg') }}" alt class="w-px-40 h-auto rounded-circle"/>
                  <defs>
                    <path
                  ...
                  <g id="g-app-brand" stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                    ...
                    <span class="app-brand-text demo menu-text fw-bolder ms-2">begov</span>
                </a>
            ...
            <ul class="menu-inner py-1">
                <!-- Dashboard -->
                <li class="menu-item @if(Route::is('chapters.index')) active @endif">
                    <a href="{{ route('chapters.index') }}" class="menu-link">
                        <i class="menu-icon tf-icons bx bx-file"></i>
                        <div data-i18n="Analytics">Boblar</div>
                    </a>
                </li>
                @role('super-user')
                        ...
                        <ul class="menu-sub">
                            <li class="menu-item @if(Route::Is('lesson-1.index')) active @endif">
                                <a href="{{ route('lesson-1.index') }}" class="menu-link">
                                    <div data-i18n="Without menu">1-Dars</div>
                                </a>
                            </li>
                            <li class="menu-item @if(Route::Is('lesson-2.index')) active @endif">
                                <a href="{{ route('lesson-2.index') }}" class="menu-link">
                                    <div data-i18n="Without menu">2-Dars</div>
                                </a>
                            </li>
                            <li class="menu-item @if(Route::Is('lesson-1.index')) active @endif">
                                <a href="{{ route('lesson-1.index') }}" class="menu-link">
                                    <div data-i18n="Without menu">3-Dars</div>
                                </a>
                            </li>
                            <li class="menu-item @if(Route::Is('lesson-1.index')) active @endif">
                                <a href="{{ route('lesson-1.index') }}" class="menu-link">
                                    <div data-i18n="Without menu">4-Dars</div>
                                </a>
                            </li>
                            <li class="menu-item @if(Route::Is('lesson-1.index')) active @endif">
                                <a href="{{ route('lesson-1.index') }}" class="menu-link">
                                    <div data-i18n="Without menu">5-Dars</div>
                                </a>
                            </li>
                            <li class="menu-item @if(Route::Is('lesson-1.index')) active @endif">
                                <a href="{{ route('lesson-1.index') }}" class="menu-link">
                                    <div data-i18n="Without menu">6-Dars</div>
                                </a>
                            </li>
                            <li class="menu-item @if(Route::Is('lesson-1.index')) active @endif">
                                <a href="{{ route('lesson-1.index') }}" class="menu-link">
                                    <div data-i18n="Without menu">7-Dars</div>
                                </a>
                            </li>
                            <li class="menu-item @if(Route::Is('lesson-1.index')) active @endif">
                                <a href="{{ route('lesson-1.index') }}" class="menu-link">
                                    <div data-i18n="Without menu">8-Dars</div>
                                </a>
                            </li>
                            <li class="menu-item @if(Route::Is('lesson-1.index')) active @endif">
                                <a href="{{ route('lesson-1.index') }}" class="menu-link">
                                    <div data-i18n="Without menu">9-Dars</div>
                                </a>
                            </li>
                            <li class="menu-item @if(Route::Is('lesson-1.index')) active @endif">
                                <a href="{{ route('lesson-1.index') }}" class="menu-link">
                                    <div data-i18n="Without menu">10-Dars</div>
                                </a>
                            </li>
                            <li class="menu-item @if(Route::Is('lesson-1.index')) active @endif">
                                <a href="{{ route('lesson-1.index') }}" class="menu-link">
                                    <div data-i18n="Without menu">11-Dars</div>
                                </a>
                            </li>
                            <li class="menu-item @if(Route::Is('lesson-1.index')) active @endif">
                                <a href="{{ route('lesson-1.index') }}" class="menu-link">
                                    <div data-i18n="Without menu">12-Dars</div>
                                </a>
                            </li>
                            <li class="menu-item @if(Route::Is('lesson-1.index')) active @endif">
                                <a href="{{ route('lesson-1.index') }}" class="menu-link">
                                    <div data-i18n="Without menu">13-Dars</div>
                                </a>
                            </li>
                            <li class="menu-item @if(Route::Is('lesson-1.index')) active @endif">
                                <a href="{{ route('lesson-1.index') }}" class="menu-link">
                                    <div data-i18n="Without menu">14-Dars</div>
                                </a>
                            </li>
                        </ul>
                    </li>
                            ...
                            <a class="nav-link dropdown-toggle hide-arrow" href="javascript:void(0);"
                               data-bs-toggle="dropdown">
                                <div class="avatar avatar-online">
                                    <img src="{{ asset('admin_assets/img/avatars/1.jpg') }}" alt
