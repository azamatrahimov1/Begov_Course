<x-guest-layout>
    <form action="" method="POST">
        ...
        <!-- Name -->
        <div>
            <x-input-label for="name" :value="__('To\'liq Ism')"/>
        ...
        <!-- Phone Number -->
        <div class="mt-4">
            <x-input-label for="phone_number" :value="__('Telefon Raqam: (Siz bilan bog\'lanish uchun)')"/>
        ...
        <!-- Phone Number -->
        <div class="mt-4">
            <x-text-input id="order_id" class="block mt-4 w-full end-50"
        ...
        <div class="flex items-center justify-end mt-4">
            <a class="underline text-sm text-gray-600 dark:text-gray-400 hover:text-gray-900 dark:hover:text-gray-100 rounded-md focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500 dark:focus:ring-offset-gray-800"
               href="{{ route('login') }}">
                {{ __('Allaqachon ro\'hatdan o\'tganmi?') }}
            </a>
